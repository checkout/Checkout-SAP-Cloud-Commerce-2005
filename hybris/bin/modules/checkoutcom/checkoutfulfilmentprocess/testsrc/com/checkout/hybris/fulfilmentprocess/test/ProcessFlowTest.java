...
@SuppressWarnings("squid:S2925") // Hybris out-of-the-box code
@IntegrationTest
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/checkoutfulfilmentprocess/test/checkoutfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/checkoutfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/checkoutfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/checkoutfulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/checkoutfulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/checkoutfulfilmentprocess/test/checkoutfulfilmentprocess-spring-testcleanup.xml"));
